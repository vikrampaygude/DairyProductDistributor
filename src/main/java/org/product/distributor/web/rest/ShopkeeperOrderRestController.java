...
@CrossOrigin
@RestController
@RequestMapping("api/shopkeeper-order")
public class ShopkeeperOrderRestController {

    private DistributorAreaService distributorAreaService;

    public ShopkeeperOrderRestController(DistributorAreaService distributorAreaService) {
